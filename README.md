...
无需安装任何 App，手机/平板用浏览器即可访问。前提：手机和电脑在**同一 WiFi** 下。
...
| 事项 | 说明 |
|------|------|
| 同一 WiFi | 手机和电脑必须连同一局域网 |
| 电脑不能关 | 电脑是服务器，关机/休眠则不可访问 |
| 防火墙 | Windows 首次会弹窗，点「允许」即可 |
| 外网访问 | 需配置端口转发或内网穿透，不在本范围 |

> 💡 **添加到主屏幕**：手机浏览器 → 分享 → 添加到主屏幕，可以像 App 一样打开，全屏无地址栏。
